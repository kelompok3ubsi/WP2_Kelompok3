...
class User extends CI_Controller {
    ...
    public function add()
    {
        ...
        $this->form_validation->set_message('is_unique', '{field} ini sudah terpakai, silahkan ganti');
    ...
    public function edit($id)
{
    ...
    $this->form_validation->set_rules('username', 'Username', 'required|min_length[5]|callback_username_check');
        ...
        $this->form_validation->set_rules('password', 'Password', 'required|min_length[5]');
        $this->form_validation->set_rules('passconf', 'Konfirmasi Password', 'required|min_length[5]|matches[password]',
    array('matches' => '{field} tidak sesuai')
);
...
{
    $post = $this->input->post(null, TRUE);
    $query = $this->db->where('username', $post['username'])
