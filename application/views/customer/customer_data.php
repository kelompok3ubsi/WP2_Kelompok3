    ...
    <div class="card card-outline card-primary">
        <div class="card-header">
            <div class="d-flex justify-content-between">
                ...
                <button class="create" onclick="window.location.href='<?=site_url('customer/add')?>'">
                    ...
                    <tr>
                        ...
                        <td class="text-center" width="180px">
                            <div class="button-container">
                                <a href="<?=site_url('customer/edit/'.$data->customer_id)?>" class="edit">
                                ...
                                <a href="<?=site_url('customer/del/'.$data->customer_id)?>" id="btn-hapus" class="delete">
