...
--------------------------------------------------------------*/
#footer {
  background: url("assets/image/tiger.jpg") top center no-repeat;
  background-size: cover;
  color: #fff;
  font-size: 14px;
  text-align: center;
...
<body style="width:100%;">
  ...
  <header id="header" class="fixed-top d-flex justify-content-center align-items-center header-transparent">
    ...
    <nav id="navbar" class="navbar" style="margin-top:0px;">
      <ul>
  ...
  <section id="hero">
    <div class="hero" style="background-image: url(assets/image/herobg.png); background-size: cover;">
      ...
      <img src="assets/image/coin.png" style="width:400px;" class="coin">
  ...
  <main id="main">
    ...
    <section id="about" class="about" style="background-color: #050816;">
      <div class="container">
        ...
        <div class="section-title">
          <span class="textabout">About The Team</span>
          <h2 class="textabout">About The Team</h2>
          <br> </br>
        </div>
        ...
        <div class="helmi row">
          ...
          style="background: url(assets/image/helmi.png) center center no-repeat; background-size: cover;
                min-height: 350px; width: 350px; border: radius 50%; margin-top: 40px;"></div>
        ...
        <div class="trifah row" style="margin-left: 50px;">
        <div class="image col-lg-4 d-flex align-items-stretch justify-content-center justify-content-lg-start" 
          style="background: url(assets/image/trifah.jpg) center center no-repeat; background-size: cover;
                height: 350px; width: 400px; margin-top: 40px;"></div>
            <div class="col-lg-8 d-flex flex-column align-items-stretch">
            <div class="content ps-lg-4 d-flex flex-column justify-content-center">
              <div class="row">
    ...
    <!-- ======= My views Section ======= -->
    <section id="views" class="views" style="background-color: #050816;">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="cardproject col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
        <div class="icon-box" style="background-color: black; border-radius: 20px;">
            <img src="assets/image/sales.png" class="clickable-image" style="width: 200px; height: 120px; border-radius: 20px;" onclick="openFullscreen(this)">
    ...
    <div id="imageModal" class="image-modal">
        ...
        <img class="modal-content" id="modalImage">
          ...
          <div class="cardproject col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
          <div class="icon-box"  style="background-color: black; border-radius: 20px;">
          <img src="assets/image/report.png" class="clickable-image" style="width: 200px; height: 120px; border-radius: 20px;" onclick="openFullscreen(this)">
          <h4 class="title" style="margin-top: 10px;">
          ...
          <div class="cardproject col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
          <div class="icon-box"  style="background-color: black; border-radius: 20px;">
          <img src="assets/image/Items.png" class="clickable-image" style="width: 200px; height: 120px; border-radius: 20px;" onclick="openFullscreen(this)">
          <h4 class="title" style="margin-top: 10px;">
    ...
    </section><!-- End My views Section -->

    <!-- ======= Testimonials Section ======= -->
    <section id="testimonials" class="testimonials" style="border-top: 2px solid white; border-bottom: 2px solid white;">
    ...
    <section id="portfolio" class="portfolio" style="background-color: #050816;">
      <div class="container">
        ...
        <div class="row portfolio-container">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            ...
            <h4>Foto Dengan Mekanik Bengkel</h4>
              <a href="assets/image/bukti1.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Bukti 1"><i class="bx bx-plus"></i></a>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-web">
            ...
            <div class="portfolio-info">
              ...
              <a href="assets/image/bukti2.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Bukti 2"><i class="bx bx-plus"></i></a>
              <a href="portfolio-details.html" class="details-link" title="More Details"><i></i></a>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-app">
            ...
            <div class="portfolio-info">
              <h4>Anggota Team</h4>
              <a href="assets/image/bukti3.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Bukti 3"><i class="bx bx-plus"></i></a>
              <a href="portfolio-details.html" class="details-link" title="More Details"><i></i></a>
            </div>
          </div>
  ...
  <!-- ======= Footer ======= -->
  <footer id="footer" style="border-top: 2px solid white; border-bottom: 2px solid white;">
    <div class="container">
      <h3>Garage Genius</h3> 
      <p>Terimakasih telah menyempatkan waktunya untuk melihat project kecil dari team kami!.</p>
      <div class="social-links">
        <a href="https://x.com/" class="twitter"><i style="font-size: 24px; color:#1DA1F2;" class="bx bxl-twitter"></i></a>
        <a href="https://facebook.com/" class="facebook"><i style="font-size: 24px; color:#1877F2;" class="bx bxl-facebook"></i></a>
        <a href="https://instagram.com" class="instagram"><i style="font-size: 24px; background: linear-gradient(45deg, #f09433 0%, #e6683c 25%, #dc2743 50%, #cc2366 75%, #bc1888 100%);
  -webkit-background-clip: text;
  -webkit-text-fill-color: transparent;
  font-size: 24px; " class="bx bxl-instagram"></i></a>
        <a href="https://skype.com" style="font-size: 24px; color:#00aff0;" class="google-plus"><i class="bx bxl-skype"></i></a>
        <a href="https://linkedin.com" style="color: #0077B5; font-size: 24px;" class="linkedin"><i class="bx bxl-linkedin"></i></a>
      </div>
      <div class="copyright">
