    ...
    <div class="card card-outline card-primary">
        <div class="card-header">
            <div class="d-flex justify-content-between">
                ...
                <button class="create" onclick="window.location.href='<?=site_url('supplier/add')?>'">
                    ...
                    <tr>
                        ...
                        <td class="text-center" width="160px">
                            <div class="button-container">
                                <a href="<?=site_url('supplier/edit/'.$data->supplier_id)?>" class="edit">
                                ...
                                <a href="<?=site_url('supplier/del/'.$data->supplier_id)?>" id="btn-hapus" class="delete">
