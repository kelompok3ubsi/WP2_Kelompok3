    ...
    <div class="content">
            ...
            <table cellspacing="0" cellpadding="0">
                <tr>
                    <td style="width:200px;">
                        <?= date('Y/m/d', strtotime($sale->date)) . " " . date('H:i', strtotime($sale->sale_created)); ?>
                    </td>
                    <td>Cashier</td>
                ...
                <tr>
                    ...
                    <td style="text-align: right;">
                        <?= $sale->customer_name != null ? $sale->customer_name : "Umum" ?>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="transaction">
            <table class="transaction-table" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td colspan="2"></td>
                    <td style="text-align: left; padding-top:5px; vertical-align: top;">Sub Total :</td>
                ...
                <?php if ($sale->discount > 0) { ?>
                    <tr>
                        <td colspan="2"></td>
                        <td style="text-align: left; padding-top:5px; vertical-align: top;">Disc. Sale :</td>
                        <td style="text-align: right; padding-top:5px; vertical-align: top;">
                ...
                <tr>
                    <td colspan="2"></td>
                    <td style="text-align: left; padding-top:5px; vertical-align: top;">Grand Total:</td>
                    <td style="text-align: right; padding-top:5px; vertical-align: top;">
                ...
                <tr>
                    <td colspan="2"></td>
                    <td style="text-align: left; padding-top:5px; vertical-align: top;">Cash :</td>
                    <td style="text-align: right; padding-top:5px; vertical-align: top;">
