    ...
    <div class="card card-outline card-primary">
        <div class="card-header">
            <div class="d-flex justify-content-between">
                ...
                <button class="create" onclick="window.location.href='<?=site_url('user/add')?>'">
                    ...
                    <tr>
                        ...
                        <td class="text-center" width="160px">
                            <div class="button-container">
                                ...
                                <a href="<?=site_url('user/edit/'.$data->user_id)?>" class="edit">
                                <svg class="edit-svgIcon" viewBox="0 0 512 512">
                                    ...
                                    <a href="<?=site_url('user/del/'.$data->user_id)?>" id="btn-hapus" class="delete" style="margin-top: 10px;">
